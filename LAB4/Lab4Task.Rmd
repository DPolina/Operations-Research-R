...
![](images/clipboard-1114927573.png){width="247"}
...
# Example usage:
par <- c(0, 0) # Example parameter values
hessian_matrix <- func_hess(par)
...
row <- data.frame(
  ...
  MSE_metric = c((3.38 - Res$objective)^2)
)
...
row <- data.frame(
  ...
  num_features = c(2),
  iter = c(Res$iterations),
  MSE_metric = c((-2000 - Res$objective)^2)
)
...
row <- data.frame(
  ...
  num_features = c(2),
  iter = c(Res$iterations),
  MSE_metric = c((-0.24 - Res$objective)^2)
)
