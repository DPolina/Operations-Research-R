...
seed <- digest2int('Атакишиев Довлет')
...
x_start <- -10
y_start <- 10
# Используем функцию goldsectmin() для нахождения минимума функции
...
f_h <- function(par) {
  ...
  # Частные производные по x по xx
